...
class Player {
  constructor(client) {
    ...
    // this._client.write('spawn_player', {
    //   id: 106,
    //   uuid: this.uuid,
    //   x: this.playerData.position.x,
    //   y: this.playerData.position.y,
    //   z: this.playerData.position.z,
    //   yaw: this.playerData.position.yaw,
    //   pitch: this.playerData.position.pitch
    // })
...
exports.updateLocalPosition = (x, y, z, yaw, pitch, client) => {
  if ((typeof x == 'number' || x == null) && (typeof y == 'number' || y == null) && (typeof z == 'number' || z == null) && (typeof yaw == 'number' || yaw == null) && (typeof pitch == 'number' || pitch == null) && client) {
    var playerData = getPlayerData(client)
    if (x !== null) {
    ...
    if (z !== null) {
      playerData.position.z = z
    }
    if (yaw !== null) {
      playerData.position.yaw = yaw
    }
    if (pitch !== null) {
      playerData.position.pitch = pitch
    }
    if (x === null && y === null && z === null && yaw === null && pitch === null) {
      throw `Invalid coords: ${x} ${y} ${z} ${yaw} ${pitch}!`
    }
